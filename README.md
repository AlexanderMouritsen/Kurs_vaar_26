...
Før du starter kurset **MÅ** du ha følgende installert på maskinen din.
Hvis du ikke allerede har lastet ned disse, finner du lenkene nedenfor:

- **Node.js** 
  👉 Last ned her: [https://nodejs.org/](https://nodejs.org/)
